-- Schema 362
-- Game function: formal database table inventory audit.
-- Purpose: make formal runtime tables, legacy mirrors, evidence/reference tables, and cleanup candidates visible before destructive consolidation.
