...
public sealed class OfficialPortalWireTests
{
    ...
    public void Six_capture_activate_fixture_decodes_and_round_trips()
    {
        ...
        var result = OfficialPortalWireCodec.DecodeActivate(Build, GameplayProtocolState.World, decoded);
    ...
    [Theory]
    [InlineData("another-build", GameplayProtocolState.World, OfficialPortalWireResultCode.BuildMismatch)]
    [InlineData(Build, GameplayProtocolState.Login, OfficialPortalWireResultCode.InvalidState)]
    [InlineData(Build, GameplayProtocolState.Battle, OfficialPortalWireResultCode.InvalidState)]
    ...
    public void Activate_rejects_mutated_preserved_region()
    {
        ...
        var result = OfficialPortalWireCodec.DecodeActivate(Build, GameplayProtocolState.World, frame);
    ...
    {
        var result = OfficialPortalWireCodec.DecodeActivate(Build, GameplayProtocolState.World, Convert.FromHexString(hex));
